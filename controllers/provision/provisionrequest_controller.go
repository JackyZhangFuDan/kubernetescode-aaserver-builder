...
//+kubebuilder:rbac:groups=provision,resources=provisionrequests,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=provision,resources=provisionrequests/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=provision,resources=provisionrequests/finalizers,verbs=update
...
func (r *ProvisionRequestReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	err = r.Status().Update(context.TODO(), pr2, &client.UpdateOptions{})
	if err != nil {
